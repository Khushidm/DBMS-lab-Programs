drop database if exists companyk;
create database companyk;
use companyk;
...
-- For each department that has five employees, retrieve the department number and the number of its employees who are making more than Rs. 6,00,000.
