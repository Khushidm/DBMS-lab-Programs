drop database if exists enrollmentk;
create database enrollmentk;
use enrollmentk;
...
-- Create a trigger that prevents a student from enrolling in a course if the marks pre_requisit is less than the 40
DELIMITER //
...
FOR EACH ROW
BEGIN
    -- Prevent enrollment if prerequisite marks < 40
